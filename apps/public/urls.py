...
urlpatterns = [
    ...
    path('experiencias/comentario/crear/', views.crear_comentario, name='crear_comentario'),
    path('experiencias/comentario/<int:pk>/responder/', views.responder_comentario, name='responder_comentario'),
    path('experiencias/comentario/<int:pk>/eliminar/', views.eliminar_comentario, name='eliminar_comentario'),
